...
export default function Cart() {
  ...
  return (
    <Container>
      ...
      <div className="shadow bg-gray-100 gap-y-3 px-4 py-5 ">
        <p>
          General Price :<span>{formatNumber(totalPrice)}</span>
        </p>
        <p>
          your discount : <span>{discountprice} $</span>
        </p>
        <p>
        ...
        <div className=" flex justify-start gap-x-3">
          ...
          <input
            type="text"
            value={discount}
            className="w-full sm:w-[300px] bg-sky-50 rounded-lg px-3 py-2 text-gray-700 placeholder:text-gray-400 outline-none focus:ring-2 focus:ring-sky-300 transition"
